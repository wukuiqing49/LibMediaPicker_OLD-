...
//import com.wkq.media.ExtractFrameWorkThread;
//import com.wkq.media.PickerConfig;
//import com.wkq.media.R;
//import com.wkq.media.adapter.VideoEditAdapter;
//import com.wkq.media.data.VideoEditInfo;
//import com.wkq.media.entity.Media;
//import com.wkq.media.utils.AndroidQUtil;
//import com.wkq.media.utils.ExtractVideoInfoUtil;
//import com.wkq.media.utils.PictureUtils;
//import com.wkq.media.utils.ScreenUtils;
//import com.wkq.media.utils.StatusBarUtil;
//import com.wkq.media.view.EditSpacingItemDecoration;
//import com.wkq.media.view.RangeSeekBar;
//
//import java.io.File;
...
//    private static final String VIDEO_TRIM_URI = "video_trim_uri";
//
...
//     */
//    public static void startEditActivity(Activity context, String fileUri, String path, long maxDuration, String videoTrimPath, int resultCode) {
...
//        intent.putExtra(VIDEO_TRIM_URI, fileUri);
...
//        fileUri = getIntent().getStringExtra(VIDEO_TRIM_URI);
...
//            mExtractVideoInfoUtil = new ExtractVideoInfoUtil(this, fileUri, path);
//        } else {
//            mExtractVideoInfoUtil = new ExtractVideoInfoUtil(this, "", path);
//        }
//
...
//        if (AndroidQUtil.isAndroidQ()){
//            mExtractFrameWorkThread = new ExtractFrameWorkThread(this, fileUri, extractW, extractH, mUIHandler, path, OutPutFileDirPath, startPosition, endPosition, thumbnailsCount);
//        }else {
//            mExtractFrameWorkThread = new ExtractFrameWorkThread(this, "", extractW, extractH, mUIHandler, path, OutPutFileDirPath, startPosition, endPosition, thumbnailsCount);
//
//        }
...
//        if (AndroidQUtil.isAndroidQ()) {
//            mVideoView.setDataSource(this, Uri.parse(fileUri));
//        } else {
...
//                runOnUiThread(() -> Toast.makeText(EditVideoActivity.this,"裁剪失败",Toast.LENGTH_SHORT).show());
//            }
//
//            @Override
//            public void onSaveVideoCanceled() {
//                tipDialog.dismiss();
//                runOnUiThread(() -> Toast.makeText(EditVideoActivity.this,"取消裁剪",Toast.LENGTH_SHORT).show());
//            }
//            @Override
